...
?>
 <?php
	...
	$id=$_GET['id'];
	$query=mysqli_query($conn,"select * from students where s_id='$id'");
...
<body>
	...
	<table id="mainbodytable">
		...
		<tr>
			<td>
		<form style="margin:30px;"method="POST" action="updatestud.php?id=<?php echo $id; ?>">
		<label>Name:</label><input type="text" value="<?php echo $row['sname']; ?>" name="sname">
		<label>Email:</label><input type="text" value="<?php echo $row['email']; ?>" name="email">
        <label>Mobile No:</label><input type="text" value="<?php echo $row['mobile_no']; ?>" name="mobile_no">
