...
if(isset($_POST["submit"])){
  ...
  $name=$_POST["f_name"];
  $mobile = $_POST["mobile"];
  $query = "INSERT INTO staff VALUES('$reg', '$pass', '$name', '$mobile')";
...
<body>
    ...
    <div id ="mainbody"> 
        <table id="mainbodytable">
            <tr>
                <td style="text-align: center;font-size: 35px;margin-top: 10px;color: #2a8875;margin-bottom:30px">Add New Staff details</td>
            </tr>
            <tr>
                <td>
                <form class="" action="" method="post" autocomplete="off">
      <label for="">Reg. No: </label>
      <input type="text" name="f_id" required value="">
