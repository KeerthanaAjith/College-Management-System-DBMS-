...
<body>
    ...
    <div id ="mainbody"> 
        <table id="mainbodytable">
            <tr>
                <td style="text-align: center;font-size: 35px;margin-top: 10px;color: #2a8875;">Delete student details</td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <a style="color:Red" href="deletestud.php?id=<?php echo $rows['s_id'];?>">Delete</a>
                </td>
            </tr>
            <?php
                }
