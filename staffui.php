...
<body>
    ...
    <nav class="main-menu"> 
       ...
       <ul>
        <li>                                   
            ...
            <li>                                 
            <a href="internalstud.php">
                <i id="staricn"  class="fa fa-star fa-lg"></i>
            <span class="nav-text">Add Internal Marks</span>
            </a>
            </li>    
            <li>                                 
            <a href="attandstud.php">
                <i  id="staricn" class="fa fa-star fa-lg"></i>
    ...
    <div id ="mainbody"> 
        <table id="mainbodytable">
            <tr>
                <td colspan="2">
                    <div style="text-align: center;font-size: 35px;margin-top: 10px;color: #2a8875;">Welcome Back <?php echo $_SESSION['f_name']; ?></div>
                </td>
            </tr>
            <tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td><a href="#"><div id="coursemem"><i class="fa fa-star"></i>&nbsp;&nbsp;&nbsp;<span class="coursemen-text">Add Internal Marks</span></div></a></td>
                                        <td><a href="#"><div id="coursemem"><i class="fa fa-star"></i>&nbsp;&nbsp;&nbsp;<span class="coursemen-text">Add Attandance</span></div></a></td>
                                        <td><a href="#"><div id="coursemem"><i class="fa fa-star"></i>&nbsp;&nbsp;&nbsp;<span class="coursemen-text">View Personal Info</span></div></a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
