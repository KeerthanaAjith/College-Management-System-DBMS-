...
if ((isset($_SESSION['a_id']) && isset($_SESSION['a_name']))||(isset($_SESSION['f_id']) && isset($_SESSION['f_name']))) {
?>
<?php
 $user = 'root';
 $password = '';
...
<body>
    ...
    <div id ="mainbody"> 
        <table id="mainbodytable">
            <tr>
                <td style="text-align: center;font-size: 35px;margin-top: 10px;color: #2a8875;">Student details</td>
            </tr>
            <tr>
                <td>
